    ...
    <div class="grid grid-cols-5 grid-rows-2 gap-2 frosted dark-frosted px-2 pt-2">
        ...
        <div class="row-span-2 col-start-3 row-start-1 flex flex-col gap-1 items-center">
            <button class="cursor-pointer" onclick={() => {alert("activate heroic inspiration")}}>
                <img class="w-full object-center object-cover rounded-box border aspect-3/4" style="border-color: {character.decorations.themeColor.themeColor}" src={character.decorations.avatarUrl} alt="Avatar">
            </button>
