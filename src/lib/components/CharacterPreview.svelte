...
<div class="relative grow border border-base-200 rounded-[4px] flex flex-col">
    ...
    <div class="p-1 flex flex-row gap-2">
        <div class="h-22 aspect-square p-1 mask mask-hexagon" style="background: {character.decorations.themeColor?.themeColor || "black"}">
            <img src={character.decorations.avatarUrl || "https://www.dndbeyond.com/Content/Skins/Waterdeep/images/characters/default-avatar-builder.png"} alt="Character" class="mask mask-hexagon h-20 aspect-square object-cover object-top" />
        </div>
